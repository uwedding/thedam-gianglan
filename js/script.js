...
!(function () {
        ...
        t = new Promise(function (i, e) {
          !(function n() {
            ...
            r() - s >= a.f
              ? e()
              : o.fonts
                  .load(_((t = a.a)) + " " + t.f + "00 300px " + j(t.c), a.h)
                  .then(
                    function (t) {
  ...
  function L(t) {
    var n,
      i = t.g.a.offsetWidth,
      e = t.h.a.offsetWidth;
    ((n = i === t.f.serif && e === t.f["sans-serif"]) ||
      (n = B() && O(t, i, e)),
      n
        ? r() - t.A >= t.w
  ...
  (($.prototype.g = function (t) {
        ...
        (function (e, t, n) {
          ...
          var i = (function (t, n, i) {
              var e,
                ...
                a = [];
              for (e in n)
                !n.hasOwnProperty(e) || ((o = t.c[e]) && a.push(o(n[e], i)));
              return a;
            })(e.a, n, e.c),
            a = new $(e.c, t, o);
              ...
              ((c = a),
                ...
                (i.f || i.g) &&
                  setTimeout(function () {
                    var t = l || null,
                      n = f || {};
                    if (0 === h.length && u) T(c.a);
                    else {
                      ((c.f += h.length), u && (c.j = u));
                          ...
                          (s = null) === q &&
                            (q =
                              ...
                              (!(r = /Gecko.*Firefox\/(\d+)/.exec(
                                ...
                                42 < parseInt(r[1], 10))),
                          (s = q
                            ? new W(p(c.g, c), p(c.h, c), c.c, o, c.s, a)
                            : new F(p(c.g, c), p(c.h, c), c.c, o, c.s, t, a)),
                          i.push(s));
                      }
    ...
    (z.prototype.load = function (t) {
      ...
      for (a = 0, s = i.length; a < s; a++)
        if ((n = i[a].split(":"))[1])
          for (var c = n[1].split(","), h = 0; h < c.length; h += 1)
            r.push(new b(n[0], c[h]));
        else r.push(new b(n[0]));
      w(o, function () {
        t(r, e);
      });
    }));
        ...
        if (2 <= e.length) {
          ...
          if (c)
            for (var f = (c = c.split(",")).length, l = 0; l < f; l++)
              (r =
                !(r = c[l]).match(/^[\w-]+$/) ||
                null == (s = Q.exec(r.toLowerCase()))
                  ? ""
                  : [
                      (r = null == (r = s[2]) || "" == r ? "n" : J[r]),
                      (s =
                        null == (s = s[1]) || "" == s
                          ? "4"
                          : U[s] || (isNaN(s) ? "4" : s.substr(0, 1))),
                    ].join("")) && h.push(r);
          (0 < h.length && (a = h),
            3 == e.length &&
              ((h = []),
              0 < (e = (e = e[2]) ? e.split(",") : h).length &&
                (e = R[e[0]]) &&
                (t.c[o] = e)));
        }
        for (
        ...
        ? (n.__webfontfontdeckmodule__ || (n.__webfontfontdeckmodule__ = {}),
            ...
            for (var i, e, o, a = 0, s = n.fonts.length; a < s; ++a) {
              ...
              h.a.push(
                new b(
                  ...
                  (r = null),
                  i &&
                    ((r = i.match(/(normal|oblique|italic)/i)) &&
                      r[1] &&
                      (o = r[1].substr(0, 1).toLowerCase()),
          ...
          g(
            ...
            l(this.c) +
              ...
              ((n = this.c).m.location.hostname || n.a.location.hostname) +
              "/" +
              t +
              ".js",
            function (t) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      var o = {
        ...
        lineHeight: null,
        justify: !1,
        drawText: function (t, e, n, i, o, a) {
          var u = this,
            f = r(
              [n, i, o, a].map(function (t) {
                return parseInt(t);
              }),
              4,
            );
          if (
            ...
            t.font = b;
            var g,
              v = i + a / 2 + parseInt(this.fontSize) / 2;
            "right" === this.align
              ? ((g = s), (t.textAlign = "right"))
              : "left" === this.align
                ? ((g = n), (t.textAlign = "left"))
                : ((g = n + o / 2), (t.textAlign = "center"));
            var m = [],
              x = e.split("\n"),
              S = this.justify ? t.measureText(" ").width : 0;
            x.forEach(function (e) {
              ...
              if (n <= o) m.push(e);
                ...
                var r,
                  ...
                  f = e,
                  s = o;
                for (n = t.measureText(f).width; n > s; ) {
                  for (r = 0, i = 0, a = ""; i < s; )
                    (r++,
                      (a = f.substr(0, r)),
                      (i = t.measureText(f.substr(0, r)).width));
                  (r--, (a = a.substr(0, r)));
                  var l = r;
                  if (" " != f.substr(r, 1)) {
                    for (; " " != f.substr(r, 1) && 0 != r; ) r--;
                    (0 == r && (r = l), (a = f.substr(0, r)));
                  }
                  ((a = u.justify ? u.justifyLine(t, a, S, " ", o) : a),
                    (f = f.substr(r)),
                    (n = t.measureText(f).width),
                    m.push(a));
                }
                0 < n && m.push(f);
              }
            ...
            return (
              ...
              m.forEach(function (e) {
                ((e = e.trim()), t.fillText(e, g, v), (v += T));
              }),
              this.debug &&
                ((t.lineWidth = 3),
                (t.strokeStyle = "#00909e"),
                t.strokeRect(n, i, o, a),
                (t.lineWidth = 2),
        ...
        getTextHeight: function (t, e, n) {
          var r = t.textBaseline,
            i = t.font;
          ((t.textBaseline = "bottom"), (t.font = n));
          var o = t.measureText(e).actualBoundingBoxAscent;
          return ((t.textBaseline = r), (t.font = i), o);
        },
        justifyLine: function (t, e, n, r, i) {
          var o = Math.floor,
            a = e.trim(),
            u = t.measureText(a).width,
            f = a.split(/\s+/).length - 1,
            s = o((i - u) / n);
          if (0 >= f || 0 >= s) return a;
          for (var l = o(s / f), c = s - f * l, h = [], d = 0; d < l; d++)
            h.push(r);
          return (
            (h = h.join("")),
            a.replace(/\s+/g, function (t) {
              var e = 0 < c ? h + r : h;
              return (c--, t + e);
            })
          );
...
var isShowIntroModal = true;
var checkShowScrollMouseButton = function (onResize = false) {
  var containerHeight = $(".invitation-container").height();
  var divHeight = $(".invitation-container > div").height();
  if (containerHeight > divHeight * 2) {
    if (!onResize) {
      $(".mouse-scroll").css("visibility", "visible");
    }
  } else {
    $(".mouse-scroll").css("visibility", "hidden");
  }
};
window.addEventListener(
  "resize",
  function (event) {
    checkShowScrollMouseButton(true);
  },
  true,
);
...
window.addEventListener(
  ...
  function () {
    ...
    var name = params.get("n") || params.get("name");
    var guestName =
      params.get("target") === "bride" ? "Bạn cô dâu" : "Bạn chú rể";
