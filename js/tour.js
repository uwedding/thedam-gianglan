    ...
    var t = {
        362: (t, e, i) => {
          ...
          function J(t, e, i) {
            ...
            e &&
              z(t) &&
              ((l = (t.offsetWidth > 0 && $(a.width) / t.offsetWidth) || 1),
              (c = (t.offsetHeight > 0 && $(a.height) / t.offsetHeight) || 1));
              ...
              : W(e)
                ...
                : c(
                    (function (t) {
                      ...
                      return (
                        "rtl" === M(o || i).direction &&
                          (a += X(i.clientWidth, o ? o.clientWidth : 0) - r),
                        {
                          width: r,
                          height: s,
                          x: a,
          ...
          e.default = function () {
            return new Promise(async (t) => {
              ((this.backdrop.style.display = "block"),
                ...
                window.onresize ||
                  (window.onresize = () => {
                    ((0, n.computeBackdropPosition)(this),
            ...
            (e.default = async function (t = !0, e = "tour") {
              ...
              if (this.options.completeOnFinish) {
                if (!localStorage.tg_tours_complete)
                  return void (localStorage.tg_tours_complete = [e]);
            ...
            (e.default = async function (t) {
              return new Promise(async (e, i) => {
                if (
                  ("string" == typeof t &&
                    (t =
                      "next" === t ? this.activeStep + 1 : this.activeStep - 1),
                  !(t >= this.tourSteps.length))
                )
                  return (await s(this, t).catch((t) => i(t)), e(!0));
