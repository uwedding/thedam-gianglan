import "https://marriage.iwedding.info/common/emoji-picker/js/index.js";
$(".textarea-emoji-picker emoji-picker").dataSource = "../data.json";
$(document).ready(function () {
  $(document).on(
    "emoji-click",
    ".textarea-emoji-picker emoji-picker",
    function (e) {
      let formInput = $(this)
        .parents(".textarea-emoji-picker")
        .find("textarea");
  ...
  $(document).on(
    "click",
    "emoji-picker, .emoji-picker, .emoji-picker-button",
    function (e) {
      e.stopPropagation();
    },
  );
